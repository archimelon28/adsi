        ...
        $data['breadcrumbs'] = array('Home' => '#');
         ...
         if($this->form_validation->run() == false) {
            ...
            if(!empty($_FILES['fileURL']['name'])) { 
                ...
                $flag = 0;
                $createArray = array('id_kelas','nama_kelas');
                $makeArray = array('id_kelas' => 'id_kelas','nama_kelas' => 'nama_kelas');
                $SheetDataKey = array();
                ...
                if ($flag == 1) {
                    for ($i = 2; $i <= $arrayCount; $i++) {
                        $addresses = array();
                        $id_kelas = $SheetDataKey['id_kelas'];
                        ...
                        $fetchData[] = array('id_kelas' =>  $id_kelas,'nama_kelas' => $nama_kelas);
                    }   
                    $data['dataInfo'] = $fetchData;
                    $this->M_Kelas->setBatchImport($fetchData);
                    $this->M_Kelas->importData();
                } else {
